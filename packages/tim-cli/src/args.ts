...
const COMMAND_VALUE_OPTIONS: Record<string, ReadonlySet<string>> = {
  ...
  'sync push': new Set(['passphrase', 'secret-passphrase', 'deadline']),
  'sync pull': new Set(['passphrase', 'secret-passphrase', 'deadline']),
  'sync owner': new Set(['passphrase', 'secret-passphrase', 'interval', 'deadline']),
